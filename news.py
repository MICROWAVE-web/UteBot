...
from programm_files import load_news_settings, save_news
...
class NewsFilterDialog(QDialog):
    ...
    def __init__(self, settings, parent=None):
        ...
        self.setWindowTitle("Настройка новостного фильтра")
        self.setMinimumWidth(400)

        layout = QVBoxLayout(self)

        # Настройки волатильности
        layout.addWidget(QLabel("Укажите промежутки времени в минутах для фильтрации новостных событий:"))

        # Низкая волатильность
        low_group = QGroupBox("Низкая волатильность")
        low_layout = QHBoxLayout(low_group)

        low_layout.addWidget(QLabel("Время До:"))
        ...
        low_layout.addWidget(QLabel("Время После:"))
        ...
        med_group = QGroupBox("Средняя волатильность")
        med_layout = QHBoxLayout(med_group)

        med_layout.addWidget(QLabel("Время До:"))
        ...
        med_layout.addWidget(QLabel("Время После:"))
        ...
        high_group = QGroupBox("Высокая волатильность")
        high_layout = QHBoxLayout(high_group)

        high_layout.addWidget(QLabel("Время До:"))
        ...
        high_layout.addWidget(QLabel("Время После:"))
        ...
        # Чекбоксы
        self.only_currency_cb = QCheckBox("Только основанные на валюте, затронутой новостями")
        self.only_currency_cb.setChecked(settings.get('only_currency', False))
        layout.addWidget(self.only_currency_cb)

        self.reverse_filter_cb = QCheckBox("Обратный новостной фильтр (торговля на новостях)")
